...
VehicleDistributions.Microwave = {
	rolls = 3,
	items = {
		"Bowl", 10,
		"WaterBowl", 5,
...
VehicleDistributions.Sidetable = {
	rolls = 3,
	items = {
		"Battery", 2,
		"Lighter", 2,
...
VehicleDistributions.CommonTemplatesDist = {
	...
	fridge = VehicleDistributions.Fridge,
	freezer = VehicleDistributions.Freezer,
	counter = VehicleDistributions.Counter,
	wardrobe = VehicleDistributions.Wardrobe,
