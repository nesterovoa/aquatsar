...
VehicleZoneDistribution.sea.vehicles["Base.BoatSailingYacht"] = {index = -1, spawnChance = 3030};
VehicleZoneDistribution.sea.vehicles["Base.BoatMotor"] = {index = -1, spawnChance = 30};
VehicleZoneDistribution.sea.specialcar = false;
VehicleZoneDistribution.sea.randomAngle = true;
VehicleZoneDistribution.sea.spawnRate = 100;

VehicleZoneDistribution.river = {};
VehicleZoneDistribution.river.vehicles = {};
VehicleZoneDistribution.river.vehicles["Base.BoatSailingYacht"] = {index = -1, spawnChance = 30};
VehicleZoneDistribution.river.vehicles["Base.BoatMotor"] = {index = -1, spawnChance = 30};
VehicleZoneDistribution.river.specialcar = false;
VehicleZoneDistribution.river.spawnRate = 100;

VehicleZoneDistribution.harbour = {};
VehicleZoneDistribution.harbour.vehicles = {};
VehicleZoneDistribution.harbour.vehicles["Base.BoatMotor"] = {index = -1, spawnChance = 30};
VehicleZoneDistribution.harbour.vehicles["Base.BoatSailingYacht"] = {index = -1, spawnChance = 30};
VehicleZoneDistribution.harbour.specialcar = false;
VehicleZoneDistribution.harbour.spawnRate = 100;

VehicleZoneDistribution.middleboat = {};
VehicleZoneDistribution.middleboat.vehicles = {};
VehicleZoneDistribution.middleboat.vehicles["Base.BoatMotor"] = {index = -1, spawnChance = 30};
VehicleZoneDistribution.middleboat.specialcar = false;
VehicleZoneDistribution.middleboat.spawnRate = 100;

VehicleZoneDistribution.bigboat = {};
VehicleZoneDistribution.bigboat.vehicles = {};
VehicleZoneDistribution.bigboat.vehicles["Base.BoatSailingYacht"] = {index = -1, spawnChance = 30};
VehicleZoneDistribution.bigboat.spawnRate = 100;
...
VehicleZoneDistribution.shipwreckland.vehicles["Base.BoatSailingYacht_shipwreckland"] = {index = -1, spawnChance = 30};
VehicleZoneDistribution.shipwreckland.spawnRate = 100;
...
VehicleZoneDistribution.shipwreckwater.vehicles["Base.BoatSailingYacht_shipwreckwater"] = {index = -1, spawnChance = 30};
VehicleZoneDistribution.shipwreckwater.spawnRate = 100;
