...
--	self.btn_partEngine = ISButton:new(100, 53, 35, 35, "", self, ISSalingBoatDashboard.onMouseDown);
...
--	self:addChild(self.btn_partEngine);
	...
	-- self.doorTex.onclick = ISSalingBoatDashboard.onClickDoors;
	...
	-- self.engineTex.onclick = ISSalingBoatDashboard.onClickEngine;
	...
	-- self.lightsTex.onclick = ISSalingBoatDashboard.onClickHeadlights;
	...
	-- self.heaterTex.onclick = ISSalingBoatDashboard.onClickHeater;
	...
	-- self.ignitionTex.onclick = ISSalingBoatDashboard.onClickKeys;
	...
	-- self.trunkTex.onclick = ISSalingBoatDashboard.onClickTrunk;
...
-- function ISSalingBoatDashboard.damageFlick(character)
	-- local dash = nil;
...
function ISSalingBoatDashboard:setVehicle(vehicle)
...
function ISSalingBoatDashboard:checkEngineFull()
...
-- function ISSalingBoatDashboard:onClickEngine()
...
-- function ISSalingBoatDashboard.onEnterVehicle(character)
	-- print("onEnterBOAT")
	-- local vehicle = character:getVehicle()
...
-- function ISSalingBoatDashboard.onExitVehicle(character)
	-- if instanceof(character, 'IsoPlayer') and character:isLocalPlayer() then
...
-- function ISSalingBoatDashboard.onSwitchVehicleSeat(character)
	-- if instanceof(character, 'IsoPlayer') and character:isLocalPlayer() then
		-- local vehicle = character:getVehicle()
...
-- function ISSalingBoatDashboard.OnGameStart()
	...
	-- for i=1,getNumActivePlayers() do
		...
		-- if playerObj and not playerObj:isDead() and playerObj:getVehicle() then
			-- ISSalingBoatDashboard.onEnterVehicle(playerObj)
		-- end
	-- end
-- end
...
-- Events.OnEnterVehicle.Add(ISSalingBoatDashboard.onEnterVehicle)
-- Events.OnExitVehicle.Add(ISSalingBoatDashboard.onExitVehicle)
-- Events.OnSwitchVehicleSeat.Add(ISSalingBoatDashboard.onSwitchVehicleSeat)
-- Events.OnGameStart.Add(ISSalingBoatDashboard.OnGameStart)
-- Events.OnVehicleDamageTexture.Add(ISSalingBoatDashboard.damageFlick)
