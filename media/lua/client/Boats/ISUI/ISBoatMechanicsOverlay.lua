...
ISBoatMechanicsOverlay.PartList["Sails"].vehicles["salingboatWS_"] = {x=72+ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYachtWithSailsLeft"].x,y=93+ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYachtWithSailsLeft"].y,x2=131+ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYachtWithSailsLeft"].x,y2=260+ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYachtWithSailsLeft"].y};
