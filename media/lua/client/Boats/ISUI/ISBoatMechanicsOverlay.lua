...
ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYachtWithSailsLeft"] = {imgPrefix = "salingboat_", x=10,y=-30};
ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYachtWithSailsRight"] = {imgPrefix = "salingboat_", x=10,y=-30};
