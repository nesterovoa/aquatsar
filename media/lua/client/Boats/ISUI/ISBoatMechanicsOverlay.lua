...
ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYacht"] = {imgPrefix = "salingboat_", x=10,y=-30};
ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYachtWithSailsLeft"] = {imgPrefix = "salingboatWS_", x=10,y=-30};
...
ISBoatMechanicsOverlay.PartList["GasTank"].vehicles["salingboat_"] = {x=146+ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYacht"].x,y=500+ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYacht"].y,x2=255+ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYacht"].x,y2=550+ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYacht"].y};
ISBoatMechanicsOverlay.PartList["GasTank"] = {img="gastank", vehicles = {}};
ISBoatMechanicsOverlay.PartList["GasTank"].vehicles["salingboatWS_"] = {x=146+ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYacht"].x,y=500+ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYacht"].y,x2=255+ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYacht"].x,y2=550+ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYacht"].y};
